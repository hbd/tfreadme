...
// readFile wraps ioutil.ReadFile with a log statement in case of failure.
...
func main() {
	...
	if rawInputs, err := readFile(*variablesFile); err == nil {
	...
	// Handle outputs.
	if rawOutputs, err := readFile(*outputsFile); err == nil {
